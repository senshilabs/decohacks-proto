...
function HackathonTab() {
                ...
                <div className="text-base leading-7 text-gray-700 lg:max-w-lg">
                  ...
                  <div className="max-w-xl">
                    <p className="mt-6 font-bold">
                      Let’s share ideas, knowledge, experiences and deep
                      connections!
                    </p>
                    <p className="mt-3">
                      Supporting the open-source movement as a non profit
                      Ethereum developer conference, Ethcon Korea have started
                      its journey since 2019. We as organizers believe that
                      Ethereum is more than just a technical solution - it is a
                      community.
                    </p>
                    <p className="mt-3">
                      Our mission is to empower local communities by bridging
                      the gap between Korea and the world through the promotion
                      of decentralized protocols, tools, and culture. Our
                      commitment to fostering innovation and community continues
                      with this Hackathon and conference, and we look forward to
                      supporting the growth of the Ethereum ecosystem here.
                    </p>
                  </div>
                </div>
  ...
  return (
    <div>
      <div className="mt-[16px] mb-[32px] flex w-full flex-col items-center">
