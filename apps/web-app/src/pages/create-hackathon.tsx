                ...
                <div className="space-y-12">
                    <div className="border-b border-gray-900/10 pb-12">
                        ...
                        <div className="">
                            ...
                            <div className="sm:col-span-4">
                                <label htmlFor="telegram" className="block text-sm font-medium leading-6 text-gray-900">
                                    telegram
                                </label>
                                <div className="mt-2 flex rounded-md shadow-sm">
                                    <input
                            ...
                            <div className="sm:col-span-4">
                                <label htmlFor="judge" className="block text-sm font-medium leading-6 text-gray-900">
                                    judge
                                </label>
                                <div className="mt-2 flex rounded-md shadow-sm">
                                    <input
