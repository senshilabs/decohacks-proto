...
export const getJudges = (contractAddress: "0x${String}") =>
    readContract({
        address: contractAddress,
        abi: ABI,
...
export const getVote = (contractAddress: "0x${String}") => (userAddress: string) =>
    readContract({
        address: contractAddress,
        abi: ABI,
        functionName: "votes",
...
export const depositEthPrize = (contractAddress: "0x${String}") => (prizeName: string, ethValue: string) =>
    writeContract({
        address: contractAddress,
        abi: ABI,
...
export const distributePrize = (contractAddress: "0x${String}") =>
    writeContract({
        address: contractAddress,
        abi: ABI,
...
export const castVote = (chain: Chain, contractAddress: "0x${String}", _identity: Identity) => async (vote: string) => {
    ...
    const { proof, merkleTreeRoot, nullifierHash } = await generateProof(_identity, group, contractAddress, signal)
